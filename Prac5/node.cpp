...
void node::setTransCheck()
{
    this->checkedTrans = true;
}

bool node::getTransCheck()
{
    return this->checkedTrans;
}
...
void node::setLineNumber(string line)
{
    lineNumber = line;
}
...
int node::getParentScope()
{
    return parentScope;
}

string node::getScopeName()
{
    return scopeName;
}
